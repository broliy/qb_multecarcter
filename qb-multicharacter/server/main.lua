...
GetSafePlayerName = function (name)
	if name == nil then
		return ""
	end
...
RegisterNetEvent('qb-multicharacter:server:loadUserData', function(cData)
    ...
    if QBCore.Player.Login(src, cData.citizenid) then
        ...
        TriggerClientEvent('qb-admin:client:showNotify', -1,"~g~".. GetSafePlayerName(GetPlayerName(src)).."~b~ ["..cData.citizenid.."],~r~ ID : "..src.." ~w~has loaded in the world.")
