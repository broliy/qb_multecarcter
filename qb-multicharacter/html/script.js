...
$(document).on('click', '#create', function (e) {
    ...
    $.post('https://qb-multicharacter/createNewCharacter', JSON.stringify({
        firstname: capitalizeFirstLetter(firstname).replace(/[^a-zA-Z ]/g, ""),
        lastname: capitalizeFirstLetter(lastname).replace(/[^a-zA-Z ]/g, ""),
        nationality: capitalizeFirstLetter(nationality).replace(/[^a-zA-Z ]/g, ""),
        birthdate: birthdate,
        gender: gender,
        cid: cid,
    }));
